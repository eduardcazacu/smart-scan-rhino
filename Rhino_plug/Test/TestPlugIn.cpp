// TestPlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"Test");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"6FA790CC-8C02-4E37-8F38-0A257D60D29A");
...
RHINO_PLUG_IN_DESCRIPTION(L"Test plug-in for Rhinoceros®");
...
// The one and only CTestPlugIn object
static class CTestPlugIn thePlugIn;
...
CTestPlugIn::CTestPlugIn()
{
  ...
  //   is loaded, CTestPlugIn::OnLoadPlugIn() is called. The
...
GUID CTestPlugIn::PlugInID() const
{
  ...
  // {6FA790CC-8C02-4E37-8F38-0A257D60D29A}
