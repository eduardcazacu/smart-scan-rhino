// TestPlugIn.h : main header file for the Test plug-in.
//
...
public:
  ...
  // CTestPlugIn destructor. The destructor is called to destroy
  // "thePlugIn" when the plug-in is unloaded. Immediately before the
  // DLL is unloaded, CTestPlugIn::OnUnloadPlugin() is called. Do
